...
- [Passive Execution Plans](passive-execution-plan.md)
- [Metadata Erasure](metadata-erasure.md)
- [Static Capability Proofs](static-capability-proofs.md)
- [Runtime Reports](runtime-reports.md)
